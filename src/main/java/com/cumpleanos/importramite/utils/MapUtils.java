...
public class MapUtils {
    ...
    public static Map<String, Producto> listByTramite(List<Contenedor> contenedores, ProductoRepository repository) {
        ...
        for (Contenedor contenedor : contenedores) {
            List<Producto> productos = repository.findByTramiteIdAndContenedorId(contenedor.getTramiteId(), contenedor.getId()).orElseThrow(() -> new ExcelNotCreateException("No se encontraron productos para el trámite: "+contenedor.getTramiteId()+" y el contenedor: "+contenedor));
